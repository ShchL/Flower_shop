package it.mirea.kursovayaflowers.addressLogic;
...
public class AddressAnalysis {
    ...
    public static final String DADATA_API_KEY = "API_KEY";
    ...
    public LiveData<List<String>> getAddressesFromPattern(String pattern) {
        ...
        api.listAddresses(new AddressRequest(pattern), "Token ".concat(DADATA_API_KEY)).enqueue(new Callback<AddressResponse>() {
            @Override
